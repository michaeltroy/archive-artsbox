...
class User < ActiveRecord::Base
 ...
 # Avatar validation.
  ...
  validates_format_of :permalink, :with => /^[A-Za-z0-9-]+$/, :message => "A <b>user address</b> can only contain letters, numbers or dashes."    
  ...
  validates_format_of :username, :with => /^[A-Za-z0-9\s+-]+$/, :message => "A <b>username</b> can only contain letters, numbers, spaces or dashes."  
